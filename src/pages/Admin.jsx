                ...
                <AnimatePresence mode="wait">
                    ...
                    {activeTab === 'playlists' && (
                        <motion.div key="playlists" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="grid lg:grid-cols-12 gap-8">
                            <div className="lg:col-span-7 space-y-4">
                                {playlists.map(pl => (
                                    <div key={pl.id} className={`${glass} p-6 rounded-[2rem] flex justify-between items-center group shadow-lg border-white/5`}>
